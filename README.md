...
* vanilla-1.4.5.4, vanilla-latest, latest [(containers/vanilla/1.4.5.4/Dockerfile)](https://github.com/beardedio/terraria/blob/main/containers/vanilla/1.4.5.4/Dockerfile)
